...
namespace EntryPoint {
    export type ProgramArguments = Record<string, any>;
    ...
    export class Application {
        ...
        public initMembers(): void {
            this.mainPath = <string>process.cwd().replace( /\\/g, '/' );
        }
...
const entryPoint = new EntryPoint.Application(<EntryPoint.ProgramArguments>minimist(process.argv.slice(2)));
